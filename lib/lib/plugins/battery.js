...
var _batteryIcon = _interopRequireDefault(require("./battery/battery-icon"));
  ...
  _createClass(Battery, [{
    ...
    value: function render() {
      var _this$state = this.state,
          charging = _this$state.charging,
          percentage = _this$state.percentage;
      return _react.default.createElement("div", {
        className: "wrapper"
      }, _react.default.createElement(_batteryIcon.default, {
        charging: charging,
        percentage: Number(percentage)
      }), " ", (0, _leftPad.default)(percentage, 2, 0), "%", _react.default.createElement("style", {
        jsx: true
      }, "\n          .wrapper {\n            display: flex;\n            align-items: center;\n          }\n        "));
    }
  }]);
